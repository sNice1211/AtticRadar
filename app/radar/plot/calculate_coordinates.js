...
function _handle_dealias(nexrad_factory, elevation, product, callback) {
    ...
    var should_plot_dealiased = window.atticData.should_plot_dealiased;
    if (nexrad_factory.nexrad_level == 2 && product == 'VEL') {
        ...
        } else if (dealias_mode_region_based) {
...
function calculate_coordinates(nexrad_factory, options) {
    ...
    _handle_dealias(nexrad_factory, elevation, product, () => {
